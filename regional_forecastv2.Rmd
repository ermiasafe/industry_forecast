...
+ current_forecast = 2026 5th Cut 
+ previous_forecast = 2026 4th Cut 
...
checkboxInput("show_trendline", "Smoothed Trend (STL)", value = FALSE),
...
employ_trend_graph <- employ_trend |> 
  ...
  ggplot(aes(
    ...
    text = paste0(
      "Year: ", year,
      "<br>Type: ", data_type,
      "<br>Employment: ", scales::comma(round(.data[[input$metric]], 0)),
