...
Notes: \
1) current_forecast = 2025 LMO \
2) previous_forecast = 2024 LMO \
3) cagr10years calculation based on \
...
tags$p(style = "color:blue;", HTML("Chart view:<br>Toggle Individual/Shared Axis")),
