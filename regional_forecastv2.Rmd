...
if (input$show_trendline && input$metric == "employment") {
  ...
  employ_trend_graph <- employ_trend_graph +
    geom_line(
      data = stl_data,
      aes(x = year, y = trend, group = interaction(lmo_industry, bc_region)),
      colour = "gray40",
      linewidth = 0.5,
      alpha = 0.8,
      inherit.aes = FALSE
  ...
  ggplotly(employ_trend_graph, tooltip = c("year", "colour", input$metric, "cagr10yrs"))
})
