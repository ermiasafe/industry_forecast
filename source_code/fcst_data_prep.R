...
vroom_write(data_region, here("input", "industryForecast_regionShares.csv"), delim = ",")
vroom_write(employment_trend_data, here("input", "industryForecast_regionTrends.csv"), delim = ",")
