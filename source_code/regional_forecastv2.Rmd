...
region_by_industry <- vroom(here("input", "industryForecast_regionShares.csv"), delim = ",") |> 
  arrange(aggregate_industry, lmo_industry)


library(scales)
employment_trend <- vroom(here("input", "industryForecast_regionTrends.csv"), delim = ",") |> 
...
Notes: \
1) previous_forecast = Industry 6th cut (2024 edition) \
